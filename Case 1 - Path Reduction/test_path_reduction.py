...
def test_pathReduc():
    ...
    assert pr.pathReduc(["NORTH", "EAST", "WEST", "SOUTH", "WEST", "WEST"]) == ["WEST", "WEST"], 'Should be ["WEST", "WEST"]'

    
def test_pathReduc_corner_cases():
    assert pr.pathReduc([]) == [], 'Should be []'
    assert pr.pathReduc(["NORTH", "SOUTH", "SOUTH", "NORTH"]) == [], 'Should be []'
    assert pr.pathReduc(["NORTH", "SOUTH", "WEST" ,"NORTH", "SOUTH"]) == ["WEST"], 'Should be ["WEST"]'
    assert pr.pathReduc(["EAST"]) == ["EAST"], 'Should be ["EAST"]'
    assert pr.pathReduc(["EAST", "EAST","EAST","EAST"]) == ["EAST", "EAST","EAST","EAST"], 'Should be ["EAST", "EAST","EAST","EAST"]'
